...
function GSHQ_discord_engine(array $server, array $viewer_data): array {
    ...
    $viewer_data['guild_name'] = $guild['name'] ?? 'N/A';
    $viewer_data['guild_id'] = $guild['id'] ?? null;
    $viewer_data['description'] = $guild['description'] ?? '';
    $viewer_data['approx_member_count'] = $data['approximate_member_count'] ?? 0;
    $viewer_data['approx_presence_count'] = $data['approximate_presence_count'] ?? 0;
